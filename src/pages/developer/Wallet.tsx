...
const Wallet = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Developer Wallet</h1>
        <p className="text-gray-600">Manage your API billing and payments</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="card text-center hover:shadow-lg transition-shadow duration-200 cursor-pointer">
          ...
          <p className="text-sm text-gray-600">Pay for API usage</p>
        </div>
